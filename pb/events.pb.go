...
func (x *BasketCheckedOut_Item) Reset() {
	*x = BasketCheckedOut_Item{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_events_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BasketCheckedOut_Item) Descriptor() ([]byte, []int) {
	return file_pb_events_proto_rawDescGZIP(), []int{2, 0}
}
...
var file_pb_events_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x40, 0x0a, 0x0d, 0x42, 0x61, 0x73, 0x6b, 0x65, 0x74, 0x53,
	...
	0x74, 0x6f, 0x6d, 0x65, 0x72, 0x49, 0x64, 0x22, 0x20, 0x0a, 0x0e, 0x42, 0x61, 0x73, 0x6b, 0x65,
	0x74, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0xca, 0x02, 0x0a, 0x10, 0x42, 0x61,
	0x73, 0x6b, 0x65, 0x74, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x64, 0x4f, 0x75, 0x74, 0x12, 0x0e,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x2f,
	0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	0x70, 0x62, 0x2e, 0x42, 0x61, 0x73, 0x6b, 0x65, 0x74, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x64,
	0x4f, 0x75, 0x74, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x1a,
	0xb4, 0x01, 0x0a, 0x04, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x74, 0x6f, 0x72,
	...
	0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x42, 0x6c, 0x0a, 0x06, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x62,
...
var file_pb_events_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pb_events_proto_goTypes = []interface{}{
	(*BasketStarted)(nil),         // 0: pb.BasketStarted
	(*BasketCanceled)(nil),        // 1: pb.BasketCanceled
	(*BasketCheckedOut)(nil),      // 2: pb.BasketCheckedOut
	(*BasketCheckedOut_Item)(nil), // 3: pb.BasketCheckedOut.Item
}
var file_pb_events_proto_depIdxs = []int32{
	3, // 0: pb.BasketCheckedOut.items:type_name -> pb.BasketCheckedOut.Item
...
func file_pb_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pb_events_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
